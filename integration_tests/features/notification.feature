...
Feature: Email notification sending
	...
	Scenario: Registration service is available
		When I send "GET" request to "http://registration_service:8088/"
		Then The response code should be 200
		And The response should match text "OK"

	Scenario: Notification event is received
		When I send "POST" request to "http://registration_service:8088/api/v1/registration" with "application/json" data:
		"""
		{
			"first_name": "otus",
			"email": "otus@otus.ru",
